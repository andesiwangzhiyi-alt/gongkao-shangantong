...
| 功能 | 说明 |
|------|------|
| 📝 **行测刷题** | 五大模块（常识判断 / 言语理解 / 数量关系 / 判断推理 / 资料分析），**40003 题**（90 原创 + 804 精选 + **4233 国考真题** + **26387 模考大赛题** + **8489 省考真题**），每题附详细解析与考点标签 |
...
│   ├── questions5.js   # 国考真题题库：4233题（2012-2026 历年国考，含完整解析/正确率/考点）
│   ├── questions6.js   # 模考大赛题库：26387题（粉笔模考200套，图片引用在线CDN）
│   ├── questions7.js   # 省考真题题库：8489题（30省 2021-2026，来自渲染页文本）
...
App 内已内置 **4233 道历年国考行测真题**（2012-2026 全覆盖，副省级/地市级/行政执法卷），每道题包含：
- ✅ 完整题干 + 4 选项 + 标准答案
- ✅ 粉笔官方文字解析（含解题思路）
- ✅ 全站正确率 + 考点标签

> 真题数据来自粉笔公开真题页（用户账号登录后渲染抓取），仅用于个人学习。**解析版权归粉笔所有**，请勿商用或二次分发。

## 🖼️ 图片资源说明

- **国考真题图片**（5611 张：图表/图形/公式图）已本地化，随仓库发布（`assets/img/`），离线可用
- **模考大赛图片**（4081+ 张）引用在线 CDN（GitHub 仓库容量有限），本地备份于 `D:\gongkao_images\`
